    ...
    $('#inputToken').bind('input propertychange', function() {
        ...
        function(data) {
            if(data.codes==200){
                ...
                $('#tokenDescription').html("This is a invalid CAVATICA token, please provide a correct one. You can find your authentication token from <a href='https://cavatica.sbgenomics.com/account/#developer'>Developer Dashboard</a>. See <a href='http://docs.cavatica.org/docs/the-api#section-authentication'>more details</a>.")
